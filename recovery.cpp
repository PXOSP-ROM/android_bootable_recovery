...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  std::string model = android::base::GetProperty("ro.product.system.model", "Unknown device");
  std::string ver = android::base::GetProperty("ro.build.version.pxosp", "Unknown version");

  std::vector<std::string> title_lines = {};

  title_lines.push_back("Model: " + model);
  title_lines.push_back("PXOSP Version: " + ver);
